...
export default function MenuBurger({
  ...
  return (
    <div
      className={`menu-burger ${isBurgerMenuActive && 'menu-burger_active'} `}
    >
        ...
        <nav className='menu-burger__nav'>
          <ul className='menu-burger__list'>
            <li className='menu-burger__item'>
              <Link
                className={`menu-burger__link ${
                  isMainPage && 'menu-burger__link_active'
                } text-link`}
                to='/'
              >
                Главная
            ...
            <li className='menu-burger__item'>
              <Link
                className={`menu-burger__link ${
                  isMoviePage && 'menu-burger__link_active'
                }  text-link`}
                to='/movies'
              >
                Фильмы
            ...
            <li className='menu-burger__item'>
              <Link
                className={`menu-burger__link ${
                  isSavedMoviePage && 'menu-burger__link_active'
                }  text-link`}
                to='/savedmovies'
              >
                Сохранённые фильмы
